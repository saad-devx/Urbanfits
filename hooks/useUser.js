...
const useUser = create(persist((set, get) => ({
    ...
    wishList: [],
    notifications: [],
    country: { name: "United Arab Emirates", code: "+971", country: "ae", src: "/AE.webp" },
    ...
    logOut: async (router) => {
        try {
            ...
            set(() => ({ user: null, address: null, notifications: [], wishList: [], recentItems: [], country: { name: "United Arab Emirates", code: "+971", country: "ae", src: "/AE.webp" } }))
            localStorage.clear()
