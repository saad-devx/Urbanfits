...
export default function ListingShopSection(props) {
    return (
        <div className="relative w-full h-[430px] flex justify-between">
            ...
            <div className="absolute top-0 right-0 lg:w-3/5 h-full">
                <Image width={1000} height={450} src={props.img} className='h-full float-right object-cover object-right' />
            </div>
        </div>
    )
}
