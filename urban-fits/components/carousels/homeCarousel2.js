...
export default function HomeCarousel2() {
    ...
    return (
        <>
            <div className="w-full h-[40vh] lg_layout_height my-14 bg_metal_gold px-14">
                <div className="flex flex-wrap items-center -mx-4">
                    <div className="md:w-1/3 w-2/5 px-4">
                        <div className="content-wrapper md:mb-12 mb-6">
                            <h2 className="text-2xl lg:text-[32px] font_gotham_medium mb-5 tracking-widest">URBAN <br /> NEW ARRIVAL</h2>
                        </div>
                        {/*.pagination-wrapper*/}
