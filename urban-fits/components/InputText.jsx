...
export const InputText = (props) => {
    ...
    return (
        <div className={`${props.classes} relative flex flex-col`} >
            ...
            <input {...props} className={`${props?.width || "w-full"} ${props.mt || "mt-3"} ${props.className} ${props?.h || "h-[44px]"} px-[10px] py-[13.5px] ${props?.border || "border border-gray-300 focus:border-yellow-700 hover:border-yellow-600 transition"} ${props?.rounded || "rounded-lg"} outline-none `} />
