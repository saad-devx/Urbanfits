...
export default function Shoppingcard(props) {
    ...
    return (
        <div key={props.li_key} className={`relative bg-gray-100 border ${props.HomeSection?'lg:w-[32%] md:h-[549px]': 'md:w-[32%] lg:w-[315px] h-[31vh] lg:h-[460px]'} w-48pr ${props.margin?props.margin:'mr-auto'} my-3 md:my-5 rounded-2xl lg:rounded-3xl shadow-md hover:scale-[1.01] hover:rounded-xl font_gotham transition-all duration-500 overflow-hidden`} >
            <Link href={`/products/product/${props.id}`}>
                ...
                <div className=" w-full h-full my-2 lg:my-4 px-3 text-black flex flex-col items-center">
                    ...
                    <div className="w-full my-1 md:my-5 flex justify-between font_gotham text-[10px] md:text-[13px]">
