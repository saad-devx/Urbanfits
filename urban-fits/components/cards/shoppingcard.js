...
export default function Shoppingcard(props) {
    ...
    return <div key={props.li_key} className={`relative bg-gray-100 ${props.classes ? props.classes : "w-full min-h-[250px] h-[250px] md:h-[300px] lg:h-[370px] xl:h-[440px] 2xl:h-[460px]"} ${props.margin ? props.margin : 'mr-auto my-3 md:my-5'} rounded-2xl lg:rounded-3xl hover:scale-[1.01] hover:rounded-xl transition-all duration-500 overflow-hidden`} >
        ...
        <Link href={props.link || `/products/product/64806298f7cd24b01e205f3f`}>
            <div className="relative w-full h-3/4 lg:h-[70%] xl:h-[72%] pt-3 lg:pt-5">
            ...
            <div className="w-full h-1/5 md:h-1/5 lg:h-1/5 py-2 lg:py-3 px-4 text-black flex flex-col items-center">
                ...
                <div className='w-full px-0 md:px-3 my-1 md:my-2 flex flex-row-reverse lg:flex-row justify-between items-center font_urbanist text-[10px] lg:text-sm '>
                    <span className='hidden lg:block'>{props.product.variants.length} Color(s)</span>
