    ...
    return (
        <div key={props.li_key} className={`relative bg-[#eaeaea] border ${props.classes ? props.classes : 'w-full min-h-[212px] h-[225px] md:h-[290px] lg:h-[430px] xl:h-[470px] 2xl:h-[520px]'} ${props.margin ? props.margin : 'mr-auto my-3 md:my-5'} rounded-2xl lg:rounded-3xl hover:scale-[1.01] hover:rounded-xl font_gotham transition-all duration-500 overflow-hidden`} >
            ...
            <Link href={`/products/product/${props.id}`}>
                ...
                <div className="w-full h-1/5 md:h-1/5 lg:h-[17%] py-2 lg:py-4 px-3 text-black flex flex-col items-center">
