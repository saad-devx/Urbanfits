...
export default function Search(props) {
    ...
    return <div className={`${props.classes} relative z-50 w-full md:w-4/5 lg:w-1/3 xl:w-2/5 h-9 lg:h-10 px-6 justify-between items-center font_urbanist bg-gray-100 text-xs md:text-sm rounded-full`}>
