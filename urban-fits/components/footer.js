        ...
        <>
            <footer className="border-t w-full pt-10 font_gotham text-gotham-black bg-white">
                <section className="pt-10 md:p-20 lg:py-28 md:pb-7">
                    <div className="w-full h-2/6 pb-7 px-6 md:pb-16 lg:px-0 border-b border-b-gray-400 flex flex-row flex-wrap justify-between items-start">
                        <span className='w-1/2 md:w-1/5 mx-auto lg:mx-0 mb-7 flex flex-col justify-center text-center' >
                            <i className="fa-solid fa-wallet text-black mb-5 text-xl"></i>
                            <h5 className="text-10px md:text-lg font_gotham_medium tracking-widest lg:tracking-expand">100% SECURE PAYMENT</h5>
                            <p className=" text-10px lg:text-13px">Moving your card details to a much more secured place</p>
                        </span>
                        <span className='w-1/2 md:w-1/5 mx-auto lg:mx-0 mb-7 flex flex-col justify-center text-center' >
                            <i className="fa-solid fa-wallet text-black mb-5 text-xl"></i>
                            <h5 className="text-10px md:text-lg font_gotham_medium tracking-widest lg:tracking-expand">TRUST PAY</h5>
                            <p className=" text-10px lg:text-13px">100% payment protection. Easy return and policy</p>
                        </span>
                        <span className='w-1/2 md:w-1/5 mx-auto lg:mx-0 mb-7 flex flex-col justify-center items-center text-center' >
                            ...
                            <h5 className="text-10px md:text-lg font_gotham_medium tracking-widest lg:tracking-expand">HELP CENTER</h5>
                            <p className=" text-10px lg:text-13px">Got a question ? Look no further. Browser our FAQs or submit your query here.</p>
                        </span>
                        <span className='w-1/2 md:w-1/5 mx-auto lg:mx-0 mb-7 flex flex-col justify-center items-center text-center' >
                            <Image className='mb-5' src={truck} alt="delivery vehicle" />
                            <h5 className="text-10px md:text-lg font_gotham_medium tracking-widest lg:tracking-expand">EXPRESS SHIPPING</h5>
                            <p className=" text-10px lg:text-13px">Moving your card details to a much more secured place</p>
                        </span>
                    </div>
                    ...
                    <div className="w-full mt-10 px-6 lg:px-0 flex flex-col lg:flex-row justify-between items-start md:items-start">
                        <div className="w-full md:w-1/5 text-sm font-thin pb-10 md:pb-3 space-y-4 flex flex-col items-center md:items-start">
                            <h1 className="text-[26px] font_gotham_medium tracking-widest"><Link href="/">URBAN FITS</Link></h1>
                        ...
                        <div className="list-none text-sm font-thin pb-7 md:pb-3 space-y-4 flex flex-col items-start">
                            <h3 className=" text-lg font_gotham_medium tracking-widest">SERVICES</h3>
                            <li>
                                <Link href='/'>HELP</Link>
                            </li>
                            <li>
                            ...
                            <li>
                                <Link href='/sizeguides'>SIZE GUIDES</Link>
                            </li>
                            <li>
                                <Link href='/'>SITE MAP</Link>
                            </li>
                            <li>
                                <Link href='/'>CF PRODUCTS</Link>
                            </li>
                            <li>
                        ...
                        <div className="list-none text-sm font-thin pb-7 md:pb-3 space-y-4 flex flex-col items-start">
                            <h3 className=" text-lg font_gotham_medium tracking-widest">EXPLORE</h3>
                            <li>
                        ...
                        <div className="list-none text-sm font-thin pb-7 md:pb-3 space-y-4 flex flex-col items-start">
                            <h3 className=" text-lg font_gotham_medium tracking-widest">YOUR ORDERS</h3>
                            <li>
                        ...
                        <div className="list-none text-sm font-thin pb-7 md:pb-3 space-y-4 flex flex-col items-start">
                            <h3 className=" text-lg font_gotham_medium tracking-widest">ABOUT UFs</h3>
                            <li>
                        ...
                        <div className="w-full md:w-1/5 flex flex-col justify-center md:justify-start items-center md:items-end text-sm font-thin space-y-4">
                            <h3 className="text-lg font_gotham_medium tracking-widest"><Link href="/contact">CONNECT</Link></h3>
                            ...
                            <p className='font_gotham'>SUPPORT@URBANFITS.AE</p>
                            <div className="flex flex-col items-end">
                                <h3 className="text-lg font_gotham_medium tracking-widest">Payment Methods</h3>
