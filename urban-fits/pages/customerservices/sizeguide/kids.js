...
export default function Kids() {
    return (
        <CutomerServices>
            ...
            <SizeTableAccordian title='GIRLS PAJAMA SETS, BIKINI SETS, BATHINGSUITS' headingTracking_null tableHeading='Size / Age' indexColWidth='w-32 md:w-1/5' restColsWidth='w-16 md:w-[13.3%]'
