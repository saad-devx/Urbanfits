...
export default function Women() {
    return (
        <CutomerServices>
            ...
            <SizeTableAccordian title='BEACH COVER UPS TOPS, LOUNGE TOPS, BIKINI TOPS, BRAS (ALPHA SIZES)' tableHeading='URBAN FITS' indexColWidth='w-32 xl:w-1/5' restColsWidth='w-15 xl:w-[10%]'
            ...
            <SizeTableAccordian title='BEACH COVER UPS BOTTOMS, LOUNGE BOTTOMS, BIKINI BOTTOMS, COORDINATE PANTIES' tableHeading='URBAN FITS' indexColWidth='w-32 xl:w-1/5' restColsWidth='w-15 xl:w-[10%]'
                columnHeadings={['XXS', 'XS', 'S', 'M', 'L', 'XL', '2XL', '3XL', '4XL']}
                rowsData={[
                    ['US Size', 0, 2, 4, '6-8', '8-10', '10-12', 14, 16, '18-20'],
                    ['UK Size', 4, 6, 8, '10-12', '12-14', '14-16', 18, 20, '22-24'],
            ...
            <SizeTableAccordian title='PAJAMA SETS' tableHeading='URBAN FITS' indexColWidth='w-32 xl:w-1/5' restColsWidth='w-15 xl:w-[10%]'
                columnHeadings={['XXS', 'XS', 'S', 'M', 'L', 'XL', '2XL', '3XL', '4XL']}
                rowsData={[
                    ['US Size', 0, 2, 4, '6-8', '8-10', '10-12', 14, 16, '18-20'],
                    ['UK Size', 4, 6, 8, '10-12', '12-14', '14-16', 18, 20, '22-24'],
