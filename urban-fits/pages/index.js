            ...
            <main className="w-full h-full section_container">
                ...
                <section className='w-full bg-white flex justify-center lg:justify-end transition-all ease-linear duration-500' >
                    <div className="w-full flex flex-col justify-center items-center gap-y-5 transition-all ease-linear duration-500 overflow-hidden">
                        <section className={`${carouselContainer} w-screen mb-7 lg:mb-10 flex justify-center items-center transition-all duration-500 ease-linear`}>
                        ...
                        <section className="w-full px-5 md:px-7 lg:px-10 flex justify-between flex-wrap">
                        ...
                        <div className="w-full mt-10 lg:mt-20 px-5 md:px-7 lg:px-10 flex items-center mb-3 text-sm lg:text-[20px] leading-3 font_gotham_medium tracking-expand"><h3>URBAN FITS COLLECTION&nbsp;</h3><span className="w-14 md:w-20 h-[2px] mx-1 bg-black transition-all"></span></div>
                        <section className="w-full h-screen md:h-auto lg:h-[85vh] px-5 md:px-7 lg:px-10 flex flex-col lg:flex-row justify-between gap-y-5 font_gotham">
                        ...
                        {/* Shopping Card Section */}
                        <section className="w-full h-screen md:h-auto lg:h-[85vh] px-5 md:px-7 lg:px-10 my-5 flex flex-col lg:flex-row justify-between gap-y-5 font_gotham">
                        ...
                        {/* second carousel */}
                        <section className="relative bg_metal_gold w-full h-[70vh] lg:h-87vh min-h-[300px] my-5 lg:my-10 lg:px-10 lg:pr-0 flex flex-col-reverse lg:flex-row items-center justify-center font_gotham overflow-hidden">
