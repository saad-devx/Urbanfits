...
export default function Storeis() {
    ...
    const StoryImage = (props) => {
        return <Image onClick={toggleStoryCarousel} width={1400} height={500} data-aos-duration='1000' data-aos-once={props.once} data-aos-delay={props.data_aos_delay ? props.data_aos_delay : null} data-aos={props.data_aos} src={props.src} className="w-full h-full object-cover" />
    }
            ...
            <main className='w-full bg-white transition-all ease-linear duration-500 overflow-hidden' >
                <section className="relative w-full layout_height flex flex-col justify-center items-center gap-y-5 transition-all ease-linear duration-500 overflow-hidden" >
                    ...
                    <div className="z-10 flex flex-col justify-center items-center gap-5">
                        ...
                        <h1 className="font_gotham_bold text-2xl md:text-[32px] text-white tracking-[0.15em]">{story && story.toUpperCase()}</h1>
                    </div>
                </section>
