    ...
    return (
        <>
            ...
            <main className="bg-white lg:overflow-x-hidden">
                <section className='lg:flex lg:items-center text-center lg:justify-center' >
                    ...
                    <div className={`w-[95%] md:w-3/5 lg:w-1/3 max-w-[400px] ${props.height || "h-screen lg_layout_height"} mx-auto py-16 pb-20 font_gotham bg-white`}>
                        {props.children}
                    </div>
                </section>
            </main>
