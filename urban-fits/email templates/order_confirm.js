    ...
    <table align="center" role="presentation" cellSpacing="0" cellPadding="0" border="0" width="100%"
        ...
        <tr style="width:100%">
            <td><img alt="Urban Fits"
                ...
                <p style="font-size:16px;line-height:26px;margin:16px 0">Thanks for shopping with us! We look more forward you to provide you the best.</p> <br>
                ...
                <p style="font-size:16px;line-height:26px;margin:16px 0">You can use use this ID to track your order and we will also be updating you as your order progress.</p>
