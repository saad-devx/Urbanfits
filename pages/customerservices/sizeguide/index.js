...
const img1 = '/size-categories/women_img.webp'
const img2 = '/size-categories/men_img.webp'
const img3 = '/size-categories/kids_img.webp'

const GuideCard = (props) => {
    return <Link href={props.href} className='group w-[200px]'>
        <div className='w-full aspect-square rounded-full overflow-hidden transition-all duration-500'>
