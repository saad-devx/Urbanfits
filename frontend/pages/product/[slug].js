                            ...
                            <div className="w-full flex flex-col lg:flex-row lg:space-x-2">
                                <div className="w-full lg:w-[70%] mb-3">
                                    ...
                                    <div className="w-full my-5">
                                        ...
                                        <p className="description font_futuraLTlite my-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus id nam hic cupiditate rerum similique distinctio alias beatae nisi, consequatur culpa aspernatur blanditiis?</p>
                                        <ul className='pl-4 list-disc font_futuraLTlite text-sm leading-6' >
                                            ...
                                            <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus, cumque?</li>
                                            <li>Lorem ipsum dolor sit amet consectetur adipisicing elit.</li>
                                            <li>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Odio.</li>
                                            <li>Lorem ipsum dolor sit amet.</li>
                                            <li>Lorem ipsum dolor sit amet consectetur.</li>
                                            <li>lorem bla bla bla bla</li>
                                        </ul>
