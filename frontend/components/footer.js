...
export default function Footer() {
    ...
    return (
        <footer className="border-t border-gray-300 w-full pt-10 md:pt-20 pb-36 md:pb-7 font_gotam_light bg-gray-100">
            ...
            <div className="w-full h-2/6 px-4 md:px-24 lg:px-32 pb-7 md:pb-16 border-b border-b-gray-400 flex flex-row flex-wrap justify-between items-start md:space-y-0">
                <span className='w-1/2 text-black md:w-1/5 mx-auto mb-7 flex flex-col justify-center text-center' >
                    ...
                    <h5 className=" text-base md:text-lg font_gotham">100% Secure Payment</h5>
                    <p className=" text-sm text-gray-700">Moving your card details to a much more secured place</p>
                </span>
                <span className='w-1/2 text-black md:w-1/5 mx-auto mb-7 flex flex-col justify-center text-center' >
                    <i className="fa-solid fa-wallet mb-3 text-xl"></i>
                    <h5 className=" text-base md:text-lg font_gotham">Trust Pay</h5>
                    <p className=" text-sm text-gray-700">100% payment protection. Easy return and policy</p>
                </span>
                <span className='w-1/2 text-black md:w-1/5 mx-auto mb-7 flex flex-col justify-center items-center text-center' >
                    ...
                    <span className='my-1 -translate-y-1'>
                    ...
                    <h5 className=" text-base md:text-lg font_gotham">Help Center</h5>
                    <p className=" text-sm text-gray-700">Got a question ? Look no further. Browser our FAQs or submit your query here.</p>
                </span>
                <span className='w-1/2 text-black md:w-1/5 mx-auto mb-7 flex flex-col justify-center items-center text-center' >
                    <Image className='mb-3' src={truck} alt="delivery vehicle" />
                    <h5 className=" text-base md:text-lg font_gotham">Express Shipping</h5>
                    <p className=" text-sm text-gray-700">Moving your card details to a much more secured place</p>
                </span>
            </div>
            ...
            <div className="w-full mt-10 px-7 md:px-10 lg:px-12 flex flex-row flex-wrap justify-between items-center md:items-start text-black">
                <div className="w-full md:w-1/5 text-sm font-thin pb-10 md:pb-3 space-y-4 flex flex-col items-center md:items-start">
                    <h1 className="text-2xl text-black font_gotham"><Link href="/">Urban Fits</Link></h1>
                ...
                <div className="list-none text-sm font-thin pb-7 md:pb-3 space-y-4 flex flex-col items-start">
                    <h3 className="text-black text-lg font_gotham">Get Help</h3>
                    <li>
                ...
                <div className="list-none text-sm font-thin pb-7 md:pb-3 space-y-4 flex flex-col items-start">
                    <h3 className="text-black text-lg font_gotham">General</h3>
                    <li>
                ...
                <div className="list-none text-sm font-thin pb-7 md:pb-3 space-y-4 flex flex-col items-start">
                    <h3 className="text-black text-lg font_gotham">Legal</h3>
                    <li>
                ...
                <div className="list-none text-sm font-thin pb-7 md:pb-3 space-y-4 flex flex-col items-start">
                    <h3 className="text-black text-lg font_gotham">About</h3>
                    <li>
                ...
                <div className="w-full text-black md:w-1/5 flex flex-col justify-center md:justify-start items-center md:items-end text-sm font-thin space-y-4">
                    <h3 className="text-lg font_gotham"><Link href="/contact">Contact With Us</Link></h3>
                    ...
                    <div className="flex flex-col items-end">
                        <h3 className="text-lg font_gotham">Payment Methods</h3>
