...
export default function Footer() {
    return (
        <footer className="border-t border-gray-300 w-full px-4 md:px-24 lg:px-32 pt-20 pb-36 md:pb-7 font_futuraLT bg-gray-100">
            ...
            <div className="w-full mt-10 flex flex-col md:flex-row justify-between items-center md:items-start text-gray-800">
                <div className="w-full md:w-1/5 text-sm font-thin pb-10 md:pb-3 space-y-4 flex flex-col items-center md:items-start">
                    <h1 className="text-2xl text-black">Urban Fits</h1>
                    <p className='text-xs text-center md:text-start' >This is a celebration of everything that moves you. For the power of choosing and the freedom of being. Here’s to the big, beautiful mess of movement and mindfulness that simply makes you feel good.<br /><br />500 4th St NW Suite 102 PMB 1958 Albuquerque, NM 87102<br /><br />+1 (559) 554-0082</p>
                </div>
                <div className="list-none text-sm font-thin pb-7 md:pb-3 space-y-4 flex flex-col items-center md:items-start">
                    <h3 className="text-black text-lg">Customer Support</h3>
                    <li>
                        <Link href='/'>My Account</Link>
                    </li>
                    <li>
                        <Link href='/contact'>Order History</Link>
                    </li>
                    <li>
                        <Link href='/returnsshipping'>Newsletter</Link>
                    </li>
                    <li>
                        <Link href='/user/myorders'>Specials</Link>
                    </li>
                    <li>
                        <Link href='/user/myorders'>Return</Link>
                    </li>
                </div>
                <div className="list-none text-sm font-thin pb-7 md:pb-3 space-y-4 flex flex-col items-center md:items-start">
                    <h3 className="text-black text-lg">Information</h3>
                    <li>
                ...
                <div className="list-none text-sm font-thin pb-7 md:pb-3 space-y-4 flex flex-col items-center md:items-start">
                    <h3 className="text-black text-lg">Customer Service</h3>
                    <li>
                ...
                <div className="w-full text-black md:w-1/5 flex flex-col justify-center md:justify-start items-center md:items-end text-sm font-thin space-y-4">
                    <h3 className="text-lg">Contact With Us</h3>
