...
export default function Navbar(props) {
    ...
    return (
        <>
            ...
            {props.logoNull ? null : <Image src={Logo} className={`fixed top-6 right-6 md:top-10 md:right-10 z-10 w-14 md:w-24 lg:w-20 transition-all duration-700`} alt="Urban images" ></Image>}
