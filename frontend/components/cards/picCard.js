...
export default function PicCard(props) {
    return (
        <div className='relative w-full lg:w-49pr h-full rounded-3xl font_futuraLT overflow-hidden' >
            <Image unoptimized={true} src={props.img} className={`w-full h-full object-cover ${!props.object_fit?"object-top" : props.object_fit}`} alt="Urban images" ></Image>
