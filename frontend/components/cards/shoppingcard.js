...
export default function Shoppingcard(props) {
    ...
    return (
        <div key={props.li_key} className='relative bg-white w-[48%] md:w-[32%] lg:w-[24%] h-[31vh] lg:h-[62vh] mr-auto my-5 rounded-2xl hover:scale-[1.02] hover:rounded-lg font_futuraLT transition-all duration-500 overflow-hidden' >
