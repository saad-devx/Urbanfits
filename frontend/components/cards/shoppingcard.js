...
export default function Shoppingcard(props) {
    return (
        <div className='relative bg-white w-[48%] md:w-[23%] h-[31vh] lg:h-[62vh] my-5 rounded-2xl hover:scale-[1.02] hover:rounded-lg font_futuraLT transition-all duration-500 overflow-hidden' >
            <Link href="#" >
